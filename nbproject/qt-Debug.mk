#############################################################################
# Makefile for building: seamcarve
# Generated by qmake (2.01a) (Qt 4.6.2) on: Sat Nov 3 18:28:33 2012
...
LIBS        =        -L'c:/Qt/2010.02.1/qt/lib' -lmingw32 -lqtmaind build/Debug/MinGW-Windows/seamcarve_resource_res.o -lQtGuid4 -lQtCored4 
QMAKE         = c:/Qt/2010.02.1/qt/bin//qmake.exe
IDC           = c:/Qt/2010.02.1/qt/bin//idc.exe
IDL           = midl
ZIP           = zip -r -9
DEF_FILE      = 
RES_FILE      = build/Debug/MinGW-Windows/seamcarve_resource_res.o
COPY          = cp
COPY_FILE     = $(COPY)
...
SOURCES       = Retargeting.cpp \
		main.cpp \
		RetargetWindow.cpp moc_RetargetWindow.cpp
OBJECTS       = build/Debug/MinGW-Windows/Retargeting.o \
		build/Debug/MinGW-Windows/main.o \
		build/Debug/MinGW-Windows/RetargetWindow.o \
		build/Debug/MinGW-Windows/moc_RetargetWindow.o
DIST          = 
QMAKE_TARGET  = seamcarve
DESTDIR        = dist/Debug/MinGW-Windows/ #avoid trailing-slash linebreak
TARGET         = seamcarve.exe
DESTDIR_TARGET = dist/Debug/MinGW-Windows/seamcarve.exe
...
$(DESTDIR_TARGET): ui_RetargetWindow.h $(OBJECTS) build/Debug/MinGW-Windows/seamcarve_resource_res.o
	$(LINK) $(LFLAGS) -o $(DESTDIR_TARGET) $(OBJECTS)  $(LIBS)


build/Debug/MinGW-Windows/seamcarve_resource_res.o: seamcarve_resource.rc
	windres -i seamcarve_resource.rc -o build/Debug/MinGW-Windows/seamcarve_resource_res.o --include-dir=.
...
compiler_moc_header_make_all: moc_RetargetWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_RetargetWindow.cpp
moc_RetargetWindow.cpp: Retargeting.h \
		ui_RetargetWindow.h \
		RetargetWindow.h
	C:/Qt/2010.02.1/qt/bin/\moc.exe $(DEFINES) $(INCPATH) -D__GNUC__ -DWIN32 RetargetWindow.h -o moc_RetargetWindow.cpp
...
compiler_uic_make_all: ui_RetargetWindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_RetargetWindow.h
ui_RetargetWindow.h: RetargetWindow.ui
	c:/Qt/2010.02.1/qt/bin//uic.exe RetargetWindow.ui -o ui_RetargetWindow.h
...
build/Debug/MinGW-Windows/Retargeting.o: Retargeting.cpp Retargeting.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW-Windows/Retargeting.o Retargeting.cpp

build/Debug/MinGW-Windows/main.o: main.cpp RetargetWindow.h \
		Retargeting.h \
		ui_RetargetWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW-Windows/main.o main.cpp

build/Debug/MinGW-Windows/RetargetWindow.o: RetargetWindow.cpp RetargetWindow.h \
		Retargeting.h \
		ui_RetargetWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW-Windows/RetargetWindow.o RetargetWindow.cpp

build/Debug/MinGW-Windows/moc_RetargetWindow.o: moc_RetargetWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW-Windows/moc_RetargetWindow.o moc_RetargetWindow.cpp
